...
### 🏠 Home — Live Attack Ticker & Platform Overview
![Home Page](docs/screenshots/Home_png.png)

---

### 🕸 Honeypot — HTTP Login Panel Trap
![HTTP Honeypot](docs/screenshots/Honeypot_png.png)

---

### 🕸 Honeypot — SSH Terminal Simulation
![SSH Terminal](docs/screenshots/ssh_terminal_png.png)

---

### 📊 Dashboard — Real-Time Stats & Attack Timeline
![Dashboard Timeline](docs/screenshots/dashboard_png.png)

---

### 📊 Dashboard — Risk Distribution, Top IPs & Top Credentials
![Dashboard Risk](docs/screenshots/dashbboard_png.png)

---

### 📋 Logs — Full Attack Log Table (All Services)
![Logs All](docs/screenshots/Logs_png.png)

---

### 📋 Logs — Critical SSH Attacks Filtered
![Critical Logs](docs/screenshots/critcallogs_png.png)

---

### 🧠 Analytics — Attacks by Country & ML Model Info
![Analytics Country](docs/screenshots/analtic_png.png)

---

### 🧠 Analytics — Hourly Distribution Chart
![Analytics Hourly](docs/screenshots/Anlaysss_png.png)

---

### 🧠 Analytics — ML Threat Classification Table
![ML Analysis](docs/screenshots/Analysis_png.png)

---

### 🔔 Alerts — Active Brute Force Alert Feed
![Alerts](docs/screenshots/Alerts_png.png)
